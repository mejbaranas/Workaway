...
function FormulaireAvis({ authorId, targetId, onAvisAdded }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5000/api/avis/volontaire", {
        method: "POST",
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="Décrivez votre expérience avec ce volontaire..."
            rows={4}
            required
          />
        </div>
